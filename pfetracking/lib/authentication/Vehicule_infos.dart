...
class VehiculeInfosScreen extends StatefulWidget {
  @override
  State<VehiculeInfosScreen> createState() => _VehiculeInfosScreenState();
}

class _VehiculeInfosScreenState extends State<VehiculeInfosScreen> {
